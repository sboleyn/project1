...
$("#search-btn").on("click", function () {
    ...
    var start_date = moment($("#calendar-input").daterangepicker().val().split("-")[0].trim()).format(dateFormat);
    var end_date = moment($("#calendar-input").daterangepicker().val().split("-")[1].trim()).format(dateFormat);
    console.log(city);
    console.log(country);
